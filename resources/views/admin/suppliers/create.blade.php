...
@section('content')
    <div class="container">
        <h1 class="page-title"><i class="fas fa-plus-circle"></i> Tambah Supplier</h1>

        <form action="{{ route('admin.suppliers.store') }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="nama"><i class="fas fa-user"></i> Nama Supplier:</label>
                <input type="text" id="nama" name="nama" class="form-control" placeholder="Masukkan nama supplier" required>
            </div>
